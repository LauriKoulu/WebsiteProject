...
new Vue({
	...
	methods: {
		...
		//this function is for modifying the fetched stat data for our leaderboard.
		showInfo: function(info) {
			...
			// we want to round these to 2 decimal places.
		...
		// function uses chart.js to draw our pie chart.
		initChart: function() {
		...
		// same as previous, but for the second chart.
